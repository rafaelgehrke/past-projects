 ...
 */
public class Top extends GameObj {
    public static final String IMG_FILE = "src/smb.png";
    ...
    public Top(int courtWidth, int courtHeight) {
    ...
    public void draw(Graphics g) {
        g.drawImage(img, this.getPx(), this.getPy(), 720, this.getHeight(), null);
    }
}
